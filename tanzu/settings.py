"""
Django settings for tanzu project.
...
WSGI_APPLICATION = 'tanzu.wsgi.application'
...
TAS_CLIENT_ID = env('TAS_CLIENT_ID')
TAS_CLIENT_SECRET = env('TAS_CLIENT_SECRET')
TAS_SYS_URL = env('TAS_SYS_URL')
TAS_ORIGIN = env('TAS_ORIGIN')
